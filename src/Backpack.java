...
public class Backpack {
	...
	public void putInBackpack(Notebook supply) {
		this.notebook = supply;
		log(supply);
	}
...
class Textbook extends Supply {
	...
	public void read() {
		System.out.println("The history of Mexico is long and interesting");
	}
}

class Notebook extends Supply {
	Notebook() {
		this.name = "notebook";
		System.out.println("You found your notebook!!");
	}

	public void takeNotes() {
		System.out.println("Now you can take notes about the long and beautiful history of Mexico!!! ");
	}
}
